...
ggboxplot(
  ...
  labs( #adding titles 
    title = "N. lituratus Bites by Experiment Type",
    x = "Experiment Type",
    y = "Total Bites",
...
ggsave(here("Output", "Bites_Experiment_Type.png")) #save to my output
...
ggsave(here("Output", "Bites_Treatment_Level.png")) #save to my output
```
...
ggsave(here("Output", "Algae_Preference.png")) #save to output
...
ggsave(here("Output", "Fish_size.png")) #save to output
```
